...
Combat SHALL be resolved by each side rolling one die (1–6). Higher roll MUST win. If tied, the defender MUST win. The winner SHALL gain ownership of the contested territory (it changes to the winner's team). The turn SHALL then end.
